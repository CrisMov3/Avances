...
$servername = "localhost"; // O tu host de BD
$username = "root";        // Tu usuario de BD
$password = "";            // Tu contraseña de BD
$dbname = "strokbig_db";    // El nombre de tu base de datos
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Datos de la Factura
    $factura_id_visible = $conn->real_escape_string($_POST['factura_id_visible']);
    ...
    $cuotas_pagadas = 0; // Siempre empieza en 0
    ...
    if ($stmt_cliente->execute()) {
        // 2. Obtener el ID del cliente (ya sea nuevo o existente)
        $cliente_id = $conn->insert_id;
        if ($cliente_id == 0) { // Si la llave no se duplicó, obtenemos el ID así
        ...
        if ($stmt_factura->execute()) {
            $mensaje = "¡Cliente y factura registrados exitosamente!";
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="Styles/pagos.css"> <style>
        ...
        <div class="admin-card">
            ...
            <form action="admin_facturas.php" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="factura_id_visible">ID de Factura (Ej: SB-MA05)</label>
                            <input type="text" id="factura_id_visible" name="factura_id_visible" required>
                        </div>
                        <div class="form-group">
